...
export default function CollaborationView() {
  ...
  return (
    <section className="w-full">
      <div className="mx-auto max-w-[980px] px-5 pt-10 pb-20 sm:px-8 lg:pt-16 lg:pb-28">
                ...
                >
                  <AccordionTrigger className="py-0 hover:no-underline focus-visible:ring-0 [&>svg]:hidden">
                    <div className="flex items-center gap-3 text-left">
                      <span
                        aria-hidden="true"
                        className="flex h-6 shrink-0 items-center text-[22px] font-semibold leading-none text-foreground"
                      >
                        &gt;
                      </span>

                      <p className="text-[14px] font-semibold leading-6 text-foreground sm:text-[15px]">
                        {t(`${key}.title`)}
                      </p>
                    </div>
                  </AccordionTrigger>

                  <AccordionContent className="pt-1 pl-9">
                    <p className="text-[14px] leading-[1.85] text-foreground sm:text-[15px]">
                      {t(`${key}.text`)}
                    </p>
                  </AccordionContent>
