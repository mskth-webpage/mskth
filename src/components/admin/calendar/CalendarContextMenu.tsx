...
/** Floating menu anchored to a click position with show, edit, and delete actions for a calendar event. */
export default function CalendarContextMenu({ event, position, onClose, onAction }: Props) {
