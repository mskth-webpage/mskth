...
/** Confirmation dialog for permanently deleting a project. Disables actions while deletion is in flight. */
export default function DeleteProjectDialog({ project, isDeletingId, onOpenChange, onConfirm }: Props) {
    ...
    >
      ...
      >
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {t("deleteDescription", { title: project.title })}
        </p>
